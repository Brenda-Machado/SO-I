...
void EnemyController::spawn_enemies()
{
    ...
    Enemy enemy5 = Enemy(Point(910, 500), Vector(-60, 0), _lasers);
    Enemy enemy4 = Enemy(Point(860, 400), Vector(-60, 0), _lasers);
    Enemy enemy1 = Enemy(Point(810, 300), Vector(-60, 0), _lasers);
    Enemy enemy2 = Enemy(Point(860, 200), Vector(-60, 0), _lasers);
    Enemy enemy3 = Enemy(Point(910, 100), Vector(-60, 0), _lasers);
